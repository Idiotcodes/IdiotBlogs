...
description = "In this blog we are going to learn basic data strucutures like stack, queue, linked list & binary search tree using C"
tags = [
    "C",
    "Stack",
    "queue",
